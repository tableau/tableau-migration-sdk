...
| [Pulled](~/api-python/reference/tableau_migration.migration_engine_hooks_pulled_interop.md)             | [`ContentItemPulledHookBase[TPrepare]`](~/api-python/reference/tableau_migration.migration_engine_hooks_pulled_interop.PyContentItemPulledHookBase.md) | [Code Samples/Pulled](~/samples/pulled/index.md)                             |
...
|---------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| [Initialize Migration](xref:Tableau.Migration.Engine.Hooks)                                             | None                                                                                                                                               | [`IInitializeMigrationHook`](xref:Tableau.Migration.Engine.Hooks.InitializeMigration.IInitializeMigrationHook)                | [Code Samples/Initialize Migration](~/samples/initialize-migration/index.md) |
...
| [Pulled](xref:Tableau.Migration.Engine.Hooks.Pulled)                                                    | [`ContentItemPulledHookBase<TPrepare>`](xref:Tableau.Migration.Engine.Hooks.Pulled.ContentItemPulledHookBase`1)                                    | [`IContentItemPulledHook<TPrepare>`](xref:Tableau.Migration.Engine.Hooks.Pulled.IContentItemPulledHook`1) | [Code Samples/Pulled](~/samples/pulled/index.md)                             |
