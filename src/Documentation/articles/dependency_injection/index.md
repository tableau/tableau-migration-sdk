...
Services that are configured on a per-plan or per-endpoint basis can be managed through [custom migration services](~/articles/dependency_injection/migration_services.md).
