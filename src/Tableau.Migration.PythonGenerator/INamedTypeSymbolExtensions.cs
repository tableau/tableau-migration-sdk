...
namespace Tableau.Migration.PythonGenerator
{
    public static class INamedTypeSymbolExtensions
    {
        ...
        public static bool IsStringEnum(this INamedTypeSymbol t)
            => string.Equals(t.BaseType?.Name, nameof(StringEnum<object>), StringComparison.Ordinal);

        public static bool IsAnyEnum(this INamedTypeSymbol t)
            => t.IsOrdinalEnum() || t.IsStringEnum();
    }
}
