...
{
    /// <summary>
    /// Interface for an object that can find content reference 
    /// for given content information, applying mapping rules.
    /// </summary>
    /// <remarks>
    /// Non-generic form of <see cref="IDestinationContentReferenceFinder{TContent}"/>.
    /// Named differently to remove generic/non-generic ambiguity for Python interop. 
    /// </remarks>
    public interface IMappedContentReferenceFinder : IContentReferenceFinder
    {
        /// <summary>
