...
namespace Tableau.Migration.Engine.Endpoints.Search
{
    ...
    /// </summary>
    public class DestinationContentReferenceFinderFactory
        : IDestinationContentReferenceFinderFactory
    {
        private readonly IMigration _migration;

        /// <summary>
        /// Creates a new <see cref="DestinationContentReferenceFinderFactory"/> object.
        /// </summary>
            ...
            where TContent : class, IContentReference
        {
            ...
            {
                return (IContentReferenceFinder<TContent>)_migration.Destination.GetViewsContentClient();
            }
            else
            {
                return ForDestinationContentType<TContent>();
            }
        }
        ...
        public virtual IDestinationContentReferenceFinder<TContent> ForDestinationContentType<TContent>()
            where TContent : class, IContentReference
            => _migration.Pipeline.CreateDestinationContentReferenceFinder<TContent>();
    }
}
