...
namespace Tableau.Migration.Engine.Hooks.InitializeMigration.Default
{
    ...
    {
        private readonly IEmbeddedCredentialsCapabilityManager _capabilityManager;

        public EmbeddedCredentialsPreflightCheck(
           ISharedResourcesLocalizer? localizer,
           ILogger<EmbeddedCredentialsPreflightCheck>? logger,
           IMigrationCapabilitiesEditor capabilities,
           IEmbeddedCredentialsCapabilityManager capabilityManager) : base(localizer, logger, capabilities)
        {
