...
namespace Tableau.Migration.Api.Rest.Models.Responses
{
    ...
    ///<see href="https://help.tableau.com/current/api/rest_api/en-us/REST/rest_api_ref.htm#query_data_source">Tableau API Reference</see> for documentation.
    /// </summary>
    [XmlType(XmlTypeName)]
    public class DataSourceResponse : TableauServerResponse<DataSourceResponse.DataSourceType>
    {
        /// <summary>
        ...
        public class DataSourceType : IDataSourceDetailsType
        {
            ...
            /// </summary>
            public DataSourceType() //Default constructor for serialization.
            { }

            internal DataSourceType(IDataSourceType response)
            {
                Id = response.Id;
                Name = response.Name;
            ...
            /// <summary>
            /// Gets or sets the size of the data source for the response.
            /// </summary>
            [XmlAttribute("size")]
