...
{
    /// <summary>
    /// Class representing a create cloud flow task response.
    /// See <see href="https://help.tableau.com/current/api/rest_api/en-us/REST/rest_api_ref_flow.htm#create_cloud_flow_task">Tableau API Reference</see> for documentation.
    /// </summary>
    [XmlType(XmlTypeName)]
    public class CreateCloudFlowTaskResponse : TableauServerResponse<CreateCloudFlowTaskResponse.TaskType>
    {
        /// <summary>
        ...
        public class TaskType
        {
            ...
            public class FlowRunType
            {
                ...
                /// <summary>
                /// Gets or sets the flow run spec for the response.
                /// </summary>
                ...
                public class FlowRunSpecType
                {
                    ...
                    /// <summary>
                    /// Class representing a response flow output step item.
                    /// </summary>
