...
{
    /// <summary>
    /// Class representing a cloud extract refresh task response.
    /// See <see href="https://help.tableau.com/current/api/rest_api/en-us/REST/rest_api_ref_extract_and_encryption.htm#tableau-cloud-response">Tableau API Reference</see> for documentation.
    /// </summary>
    [XmlType(XmlTypeName)]
