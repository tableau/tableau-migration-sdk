...
namespace Tableau.Migration.Api.Rest.Models.Responses.Cloud
{
    ...
    /// See <see href="https://help.tableau.com/current/api/rest_api/en-us/REST/rest_api_ref_subscriptions.htm#tableau-cloud-request1">Tableau API Reference</see> for documentation.
    /// </summary>
    [XmlType(XmlTypeName)]
