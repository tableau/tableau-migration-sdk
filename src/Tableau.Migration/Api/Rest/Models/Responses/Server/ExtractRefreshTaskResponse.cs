...
{
    /// <summary>
    /// Class representing a server extract refresh task response.
    /// See <see href="https://help.tableau.com/current/api/rest_api/en-us/REST/rest_api_ref_extract_and_encryption.htm#tableau-server-response">Tableau API Reference</see> for documentation.
    /// </summary>
    [XmlType(XmlTypeName)]
    public class ExtractRefreshTaskResponse : TableauServerResponse<ExtractRefreshTaskResponse.TaskType>
    {
        /// <summary>
