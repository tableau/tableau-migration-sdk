...
{
    /// <summary>
    /// Class representing a Get Server Subscription response.
    /// See <see href="https://help.tableau.com/current/api/rest_api/en-us/REST/rest_api_ref_subscriptions.htm#tableau-server-request1">Tableau API Reference</see> for documentation.
    /// </summary>
    [XmlType(XmlTypeName)]
    public class GetSubscriptionResponse : TableauServerResponse<GetSubscriptionResponse.SubscriptionType>
    {
        /// <summary>
