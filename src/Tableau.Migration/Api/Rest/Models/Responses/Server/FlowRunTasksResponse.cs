...
{
    /// <summary>
    /// Class representing a server flow run tasks response.
    /// See <see href="https://help.tableau.com/current/api/rest_api/en-us/REST/rest_api_ref.htm#get_flow_run_tasks">Tableau API Reference</see> for documentation.
    /// </summary>
    [XmlType(XmlTypeName)]
    public class FlowRunTasksResponse : TableauServerListResponse<FlowRunTasksResponse.TaskType>
    {
        /// <summary>
        /// Gets or sets the flow run tasks for the response.
        /// </summary>
        [XmlArray("tasks")]
        [XmlArrayItem("task")]
        ...
        public class TaskType
        {
            ...
            public class FlowRunType
            {
                ...
                public ParameterType[] Parameters { get; set; } = Array.Empty<ParameterType>();

                /// <summary>
                /// Gets or sets the flow parameter specs for the response.
                /// </summary>
                [XmlElement("flowParameterSpecs")]
                public FlowParameterSpecsType? FlowParameterSpecs { get; set; }
                ...
                public class ParameterType
                {
                    ...
                    /// <summary>
                    /// Class representing a response domain item.
                    /// </summary>
                    public class DomainType
                    {
                        /// <summary>
                        /// Gets or sets the domain type for the response.
                        /// </summary>
                        [XmlAttribute("domainType")]
                        public string? Type { get; set; }
                    }
                }

                /// <summary>
                /// Class representing a response flow parameter specs item.
                /// </summary>
                public class FlowParameterSpecsType
                {
                    // Empty class to represent the flowParameterSpecs element which can be empty
                }
            }
        }
    }
