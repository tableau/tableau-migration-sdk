...
namespace Tableau.Migration.Api.Simulation.Rest.Net.Responses
{
    ...
    /// </summary>
    internal abstract class RestResponseBuilderBase<TResponse> : IRestApiResponseBuilder
        where TResponse : TableauServerResponse, new()
    {
        ...
        public RestResponseBuilderBase(TableauData data, IHttpContentSerializer serializer, bool requiresAuthentication)
        {
            Data = data;
