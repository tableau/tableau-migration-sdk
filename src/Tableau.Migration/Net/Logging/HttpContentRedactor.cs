...
{
    internal sealed class HttpContentRedactor : IHttpContentRedactor
    {
        private static readonly Regex[] SENSITIVE_TEXT_REGEXES =
        [
            // Xml Element secrets
            new Regex(
        ...
        private static readonly string[] SENSITIVE_CONTENT_HEADER_NAMES =
        [
            "password",
            "token",
            "authenticity_token",
        ...
        public bool IsSensitiveMultipartContent(string? contentName)
        {
