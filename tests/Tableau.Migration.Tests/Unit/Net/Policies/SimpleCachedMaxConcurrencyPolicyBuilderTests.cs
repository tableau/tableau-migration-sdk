...
{
    public class SimpleCachedMaxConcurrencyPolicyBuilderTests
    {
        ...
        public static IEnumerable<object[]> GetCachedPolicyCases()
        {
            ...
            foreach (var setConfigAction in _setOtherConfigurationList)
            {
                // Default configuration - With Changes - Different Requests - New Policy
                yield return new object[]
                {
                    // request1
                    new HttpRequestMessage(),
        ...
        public SimpleCachedMaxConcurrencyPolicyBuilderTests()
        {
            ...
            Action<MigrationSdkOptions>? changeConfiguration = null)
        {
            ...
            var selector = serviceProvider.GetRequiredService<SimpleCachedMaxConcurrencyPolicyBuilder>();
