...
{
    public class SimpleCachedClientThrottlePolicyBuilderTests
    {
        ...
        private static readonly Action<MigrationSdkOptions>[] _setThrottleConfigurationList = new Action<MigrationSdkOptions>[]
        {
            (MigrationSdkOptions options) =>
            {
        ...
        public static IEnumerable<object[]> GetCachedPolicyCases()
        {
            ...
            foreach (var setConfigAction in _setThrottleConfigurationList)
            {
                // Custom retry configuration - No Changes - Same Request - Cached Policy
                yield return new object[]
                {
                    // request1
                    new HttpRequestMessage(),
        ...
        public SimpleCachedClientThrottlePolicyBuilderTests()
        {
            ...
            Action<MigrationSdkOptions>? changeConfiguration = null)
        {
            ...
            var selector = serviceProvider.GetRequiredService<SimpleCachedClientThrottlePolicyBuilder>();
