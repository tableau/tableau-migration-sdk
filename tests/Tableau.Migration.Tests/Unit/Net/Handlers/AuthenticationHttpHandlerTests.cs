...
namespace Tableau.Migration.Tests.Unit.Net.Handlers
{
    ...
    {
        public abstract class AuthenticationHttpHandlerTest : AutoFixtureTestBase
        {
            protected readonly Mock<IAuthenticationTokenProvider> MockTokenProvider = new();

            internal readonly AuthenticationHttpHandler Handler;

            public AuthenticationHttpHandlerTest()
            {
