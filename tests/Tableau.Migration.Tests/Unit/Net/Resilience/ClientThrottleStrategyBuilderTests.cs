    ...
    public class ClientThrottleStrategyBuilderTests
    {
        public class Build : ResilienceStrategyTestBase
        {
            ...
            public void StrategyEnabled()
            {
                ...
                Assert.IsType<RateLimiterStrategyOptions>(strategy.Options);

                Assert.NotNull(onDispose);
            }
        }
    }
}
