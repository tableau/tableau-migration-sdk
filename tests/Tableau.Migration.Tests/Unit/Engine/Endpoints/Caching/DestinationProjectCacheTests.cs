...
{
    public class DestinationProjectCacheTests
    {
        public class LoadStoreAsync : DestinationCacheTest<DestinationProjectCache, IProject>
        {
        ...
        public class IsProjectLockedAsync : DestinationCacheTest<DestinationProjectCache, IProject>
        {
            [Fact]
