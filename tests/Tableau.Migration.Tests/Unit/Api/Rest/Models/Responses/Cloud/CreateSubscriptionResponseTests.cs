...
{
    public sealed class CreateSubscriptionResponseTests
    {
        public sealed class Ctor : AutoFixtureTestBase
        {
            ...
            public void InitializesSubscription()
            {
                ...
                var schedule = Create<ICloudScheduleType>();

                var r = new CreateSubscriptionResponse.SubscriptionType(s, schedule);
            ...
            public void InitializesSchedule()
            {
                ...
                var r = new CreateSubscriptionResponse.SubscriptionType.ScheduleType(s);
