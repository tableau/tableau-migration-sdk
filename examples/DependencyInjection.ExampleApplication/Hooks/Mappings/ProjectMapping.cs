...
namespace DependencyInjection.ExampleApplication.Hooks.Mappings
{
    public class ProjectMapping : ContentMappingBase<IProject>
    {
        ...
        public ProjectMapping(ILogger<ProjectMapping> logger)
        {
            _logger = logger;
        ...
        public override Task<ContentMappingContext<IProject>?> ExecuteAsync(ContentMappingContext<IProject> context, CancellationToken cancel)
        {
